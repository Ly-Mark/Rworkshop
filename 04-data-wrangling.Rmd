...
To use packages we will have the the **install.packages( )** function and put in the package. We can either does this as a _chunk_ in a R-markdown file or we can type it directly into the console.
